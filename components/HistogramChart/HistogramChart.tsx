...
export default function HistogramChart({ data, isLoading }: { data: any[], isLoading: boolean }) {
    ...
    return (
        <section className={styles.container}>
            <CardHeaderOptions title="Global Internet Adoption over the years" paragraphText="The data depicts the evolution of internet users in billions and the corresponding percentage of users from 2005 to 2021. During this period, there has been a consistent upward trend in both the number of users and the percentage of users worldwide.
...
The data underscores the exponential growth of internet usage globally, reflecting its widespread adoption and integration into everyday life. This trend signifies the increasing importance of the internet as a fundamental tool for communication, information access, and economic participation on a global scale." link="https://www.itu.int/itu-d/reports/statistics/2022/11/24/ff22-internet-use/" sourceText="www.itu.int" />
            {
