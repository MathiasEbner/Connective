...
export default function BarChart({ data, isLoading }: { data: any[], isLoading: boolean }) {
    ...
    const plotData: Data[] = [{
        ...
        marker: {
            color: '526D82' // Set the color of the bars
        }
    }];

    return (
        <section className={styles.container}>
            <CardHeaderOptions title="Global Internet Usage Trends in 2023" paragraphText={paragraphText} link="https://datareportal.com/reports/digital-2024-global-overview-report" sourceText="datareportal.com/reports" />
            {
                isLoading ?
